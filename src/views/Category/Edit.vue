  ...
  methods: {
    async getDataInCategory(){
      ...
      if (docSnap.exists()) {
        ...
        console.log('this', this.dataCategory)
        this.name = this.dataCategory.name;
        this.slug = this.dataCategory.slug;
        this.store.listFiles = this.dataCategory.images;
  ...
  <div class="collection-container">
    ...
    <div class="page-content" v-else>
      <div class="box-file-created d-flex justify-content-between mb-4">
        <h2 class="box-file-search" style="color: var(--text-color)">{{ $t('Edit category') }}</h2>
